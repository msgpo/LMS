<ul>
    <li><a title="title" href="<?php echo base_url(); ?>index.php/initial/index">Index</a></li>
	...
	<li><a class="active" title="title" href="<?php echo base_url(); ?>index.php/login/index">League Manager Login</a></li>
</ul>