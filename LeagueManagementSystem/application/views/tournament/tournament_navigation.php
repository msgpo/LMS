<ul>
    <li><a title="title" href="<?php echo base_url(); ?>index.php/home/index">Home</a></li>
	...
	<li><a class="active" title="title" href="<?php echo base_url(); ?>index.php/tournamentController/index">Tournaments</a></li>
